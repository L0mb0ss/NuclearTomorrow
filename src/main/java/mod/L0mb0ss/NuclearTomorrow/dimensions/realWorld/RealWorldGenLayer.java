...
public class RealWorldGenLayer extends GenLayer {
	
	public RealWorldGenLayer(long seed) {
		super(seed);
	}
	public static GenLayer[] initializeAllBiomeGenerators (long seed) {
        ...
        Object object = new RealWorldGenLayerBiomes(200L, genlayer2);
        object = GenLayerZoom.magnify(1000L, (GenLayer) object, 2);
        object = new GenLayerBiomeEdge(1000L, (GenLayer) object);
