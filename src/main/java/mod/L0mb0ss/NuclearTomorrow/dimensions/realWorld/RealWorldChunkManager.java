...
public class RealWorldChunkManager extends WorldChunkManager {
    ...
    protected RealWorldChunkManager() {
        this.biomeCache = new BiomeCache(this);
        this.biomesToSpawnIn = new ArrayList();
        this.biomesToSpawnIn.addAll(allowedBiomes);
    }

    public RealWorldChunkManager(long p_i1975_1_, WorldType p_i1975_3_) {
        this();
        GenLayer[] agenlayer = RealWorldGenLayer.initializeAllBiomeGenerators(p_i1975_1_);
        agenlayer = getModdedBiomeGenerators(p_i1975_3_, p_i1975_1_, agenlayer);
        this.genBiomes = agenlayer[0];
        this.biomeIndexLayer = agenlayer[1];
    }

    public RealWorldChunkManager(World p_i1976_1_) {
